import n, { useState as t } from 'react'
function a(n, t) {
	var a = {}
...
function e(r) {
	var { currentColorIndex: e, colors: o, onClick: s = () => {}, size: i = 40, animDuration: m = '.4s', className: l = '', style: c = {} } = r,
		d = a(r, ['currentColorIndex', 'colors', 'onClick', 'size', 'animDuration', 'className', 'style'])
	const [f, p] = t(e || 0),
		[k, w] = t(0),
		h = e || f
	return n.createElement(
		...
		Object.assign(
			{
				className: 'ai-color-switch ' + l,
				onClick: () => {
					s(), p((f + 1) % o.length), w((k + 1) % 2)
				},
				style: Object.assign({ width: i, height: i, '--ai-color-switch-color': o[h], '--ai-color-switch-tr-sec': m, '--ai-color-switch-size': 0.558 * i + 'px' }, c),
			},
			d,
		),
		n.createElement('div', { 'aria-hidden': !0, className: `ai-color-targ ai-color-targ-${k}` }),
	)
}
r(
...
function o(r) {
	var {
		...
		f = a(r, ['darkMode', 'onClick', 'size', 'className', 'style', 'animDuration', 'lightModeColor', 'darkModeColor'])
	const [p, k] = t(e || !1),
		w = e || p,
		h = w ? d : c
	return n.createElement(
		...
		Object.assign(
			{
				...
				style: Object.assign({ '--theme-anim': h, '--tr-sec': l, width: s, height: s }, m),
			},
			f,
		),
		n.createElement(
			...
			n.createElement('circle', { cx: '15', cy: '15', r: w ? 12 : 6, id: 'moon', mask: 'url(#moon-mask)' }),
			n.createElement('mask', { id: 'moon-mask' }, n.createElement('rect', { x: '0', y: '0', width: '100%', height: '100%' }), n.createElement('circle', { cx: '21', cy: '8', r: '12' })),
			n.createElement(
				'g',
				{ mask: 'url(#dots-mask)' },
				n.createElement('circle', { cx: '5', cy: '15', r: '2', id: 'spot-1' }),
				n.createElement('circle', { cx: '10', cy: '23.66', r: '2', id: 'spot-2' }),
				n.createElement('circle', { cx: '20', cy: '23.66', r: '2', id: 'spot-3' }),
				n.createElement('circle', { cx: '25', cy: '15', r: '2', id: 'spot-4' }),
				n.createElement('circle', { cx: '10', cy: '6.4', r: '2', id: 'spot-6' }),
				n.createElement('circle', { cx: '20', cy: '6.4', r: '2', id: 'spot-5' }),
			),
			n.createElement(
				'mask',
				{ id: 'dots-mask' },
				n.createElement('rect', { x: '0', y: '0', width: '100%', height: '100%', fill: 'white' }),
				n.createElement('circle', { cx: '15', cy: '15', r: '6', fill: 'black' }),
			),
		),
	)
}
...
export { e as ColorSwitch, o as DarkModeSwitch }
